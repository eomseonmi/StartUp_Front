    ...
    return (
      <>
                ...
                <div className="active side">
                    <div className="ui card" style={{width:'500px', height:'600px'}}>
                        ...
                        <div className="content" style={{height:'30%'}}>
                            <div className="description" style={{fontSize:'22px' , display: 'flex',alignItems: 'center', height: '100%'}}><p>{selectedValue}</p>
                            </div>
                        </div>
                ...
                <div className="side"> 
                    <div className="ui card"> 
                        ...
                        <div className="content"> 
                            ...
                            <div className="description">{selectedValue}
                            </div>
                        </div>
        ...
        <div className="printbtn">
                <div>
                    <button className="huge ui right labeled icon button printbtn" >
